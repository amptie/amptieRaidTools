...
local ART_BC_BUFFS = {
    ...
    { key="ELX_DEMONSLAYING",    name="Elixir of Demonslaying",          buffName="Elixir of Demonslaying",           sec="physical",   icon="Interface\\Icons\\INV_Potion_27",                 itemKey=nil, itemIds={9224}    },
    ...
    { key="FOOD_CHIMAEROK",      name="Dirge's Kickin' Chimaerok Chops",  buffName="Increased Stamina",                sec="food",       icon="Interface\\Icons\\INV_Misc_Food_65",              itemKey=nil,  isFood=true, itemIds={21023}  },
    { key="FOOD_FISHE_CHOC",     name="Le Fishe Au Chocolat",             buffName="Increased Stamina",                sec="food",       icon="Interface\\Icons\\INV_Misc_Fishe_Au_Chocolate",   itemKey=nil,  isFood=true, itemIds={84040}  },
    { key="FOOD_WILDHAMMER_YAM", name="Mealy Wildhammer Yam",             buffName="Increased Stamina",                sec="food",       icon="Interface\\Icons\\wildhammer_yams_2",             itemKey=nil,  isFood=true, itemIds={42160}  },
    { key="FOOD_TELABIM_MEDLEY", name="Danonzo's Tel'Abim Medley",        buffName="Increased Stamina",                sec="food",       icon="Interface\\Icons\\INV_Misc_Food_73",              itemKey=nil,  isFood=true, itemIds={60978}  },
    ...
    { key="FOOD_DEEP_SEA_STEW",  name="Deep Sea Stew",                    buffName="Increased Stamina",                sec="food",       icon="Interface\\Icons\\INV_Misc_Food_63",              itemKey=nil,  isFood=true, itemIds={42164}  },
    { key="FOOD_GURUBASHI_GUMBO",name="Gurubashi Gumbo",                  buffName="Increased Stamina",                sec="food",       icon="Interface\\Icons\\inv_misc_food_101",             itemKey=nil,  isFood=true, itemIds={53015}  },
    -- Melee foods
    ...
    { key="FOOD_DESERT_DUMP",    name="Smoked Desert Dumplings",          buffName="Increased Agility",                sec="food",       icon="Interface\\Icons\\INV_Misc_Food_64",              itemKey=nil,  isFood=true, itemIds={20452}  },
    { key="FOOD_MIGHTFISH",      name="Mightfish Steak",                  buffName="Increased Stamina",                sec="food",       icon="Interface\\Icons\\INV_Misc_Food_47",              itemKey=nil,  isFood=true, itemIds={13934}  },
    { key="FOOD_GRILLED_SQUID",  name="Grilled Squid",                    buffName="Increased Agility",                sec="food",       icon="Interface\\Icons\\inv_misc_fish_37",              itemKey=nil,  isFood=true, itemIds={13928}  },
    ...
    { key="FOOD_TELABIM_SURP",   name="Danonzo's Tel'Abim Surprise",      buffName="Increased Agility",                sec="food",       icon="Interface\\Icons\\inv_misc_food_92",              itemKey=nil,  isFood=true, itemIds={60976}  },
    ...
    -- Caster/Healer foods
    { key="FOOD_NIGHTFIN",       name="Nightfin Soup",                    buffName="Mana Regeneration",                sec="food",       icon="Interface\\Icons\\INV_Drink_22",                  itemKey=nil,  isFood=true, itemIds={13931}  },
    ...
    { key="FOOD_TELABIM_DELIGHT",name="Danonzo's Tel'Abim Delight",       buffName="Mana Regeneration",                sec="food",       icon="Interface\\Icons\\INV_Drink_21",                  itemKey=nil,  isFood=true, itemIds={60977}  },
    { key="FOOD_HERBAL_SALAD",   name="Empowering Herbal Salad",          buffName="Increased Healing Bonus",          sec="food",       icon="Interface\\Icons\\INV_Misc_Food_Salad",           itemKey=nil,  isFood=true, itemIds={83309}  },
    { key="FOOD_WATERMELON",     name="Sweet Watermelon",                 buffName="Increased Intellect",              sec="food",       icon="Interface\\Icons\\inv_misc_food_111",             itemKey=nil,  isFood=true, itemIds={51718}  },
    { key="FOOD_RUNN_TUM",       name="Runn Tum Tuber Surprise",          buffName="Increased Intellect",              sec="food",       icon="Interface\\Icons\\INV_Misc_Food_63",              itemKey=nil,  isFood=true, itemIds={18254}  },
    { key="FOOD_HOT_BASS",       name="Hot Smoked Bass",                  buffName="Increased Intellect",              sec="food",       icon="Interface\\Icons\\INV_Misc_Fish_03",              itemKey=nil,  isFood=true, itemIds={13929}  },
    -- Protection food
    { key="FOOD_HONEYCOMB",      name="Honeycomb Delight",                buffName="Well Fed",                         sec="food",       icon="Interface\\Icons\\cooked_honey_1",                itemKey=nil,  isFood=true, itemIds={42186}  },
}
